...
const lisp_symbol_1 = require("./lisp-symbol");
const null_sexpression_1 = require("./null-sexpression");
class LISPGlobalInfo extends global_info_base_1.GlobalInfoBase {
    ...
    valueAsInteger(value) {
        ...
        if (valueAsNumber === undefined) {
            throw new argument_exception_1.ArgumentException('valueAsInteger() : The value is not an IntegerLiteral.', 'valueAsNumber');
        }
...
exports.LISPGlobalInfo = LISPGlobalInfo;
