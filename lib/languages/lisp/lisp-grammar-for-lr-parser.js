...
exports.LISPGrammarForLRParser = void 0;
...
class LISPGrammarForLRParser extends grammar_base_1.GrammarBase {
    ...
    constructor() {
        ...
        // Input -> FunDef
        // Productions.Add(new Production(Symbol.N_Input, new List<object>() { Symbol.N_FunDef }, 3));
        this.productions.push(new production_1.Production(symbol_1.Symbol.nonterminalInput, [symbol_1.Symbol.nonterminalFunDef], 3));
        // FunDef -> ( define Function ArgList Expression )
        // Productions.Add(new Production(Symbol.N_FunDef, new List<object>() { Symbol.T_LeftBracket, Symbol.T_Define, Symbol.N_Function, Symbol.N_ArgList, Symbol.N_Expression, Symbol.T_RightBracket, "#functionDefinition" }, 4));
        ...
        // Value -> Quoted-Const
        // Productions.Add(new Production(Symbol.N_Value, new List<object>() { Symbol.N_QuotedConst }, 39));
        this.productions.push(new production_1.Production(symbol_1.Symbol.nonterminalValue, [symbol_1.Symbol.nonterminalQuotedConst], 22));
        // Value-Op -> cons
        // Productions.Add(new Production(Symbol.N_ValueOp, new List<object>() { Symbol.T_Cons }, 40));
        this.productions.push(new production_1.Production(symbol_1.Symbol.nonterminalValueOp, [symbol_1.Symbol.terminalCons], 40));
        // Value-Op -> car
        // Productions.Add(new Production(Symbol.N_ValueOp, new List<object>() { Symbol.T_Car }, 41));
        this.productions.push(new production_1.Production(symbol_1.Symbol.nonterminalValueOp, [symbol_1.Symbol.terminalCar], 41));
        // Value-Op -> cdr
        // Productions.Add(new Production(Symbol.N_ValueOp, new List<object>() { Symbol.T_Cdr }, 42));
        this.productions.push(new production_1.Production(symbol_1.Symbol.nonterminalValueOp, [symbol_1.Symbol.terminalCdr], 42));
        // Value-Op -> number?
        // Productions.Add(new Production(Symbol.N_ValueOp, new List<object>() { Symbol.T_NumberPred }, 43));
        this.productions.push(new production_1.Production(symbol_1.Symbol.nonterminalValueOp, [symbol_1.Symbol.terminalNumberPred], 43));
        // Value-Op -> symbol?
        // Productions.Add(new Production(Symbol.N_ValueOp, new List<object>() { Symbol.T_SymbolPred }, 44));
        this.productions.push(new production_1.Production(symbol_1.Symbol.nonterminalValueOp, [symbol_1.Symbol.terminalSymbolPred], 44));
        // Value-Op -> list?
        // Productions.Add(new Production(Symbol.N_ValueOp, new List<object>() { Symbol.T_ListPred }, 45));
        this.productions.push(new production_1.Production(symbol_1.Symbol.nonterminalValueOp, [symbol_1.Symbol.terminalListPred], 45));
        // Value-Op -> null?
        // Productions.Add(new Production(Symbol.N_ValueOp, new List<object>() { Symbol.T_NullPred }, 46));
        this.productions.push(new production_1.Production(symbol_1.Symbol.nonterminalValueOp, [symbol_1.Symbol.terminalNullPred], 46));
        // Quoted-Const -> ' S-Expression
        // Productions.Add(new Production(Symbol.N_QuotedConst, new List<object>() { Symbol.T_Apostrophe, Symbol.N_SExpression, "#quotedConstantWithApostrophe" }, 47));
        ...
        // S-Expression -> Integer
        // Productions.Add(new Production(Symbol.N_SExpression, new List<object>() { Symbol.T_IntegerLiteral }, 48));
        this.productions.push(new production_1.Production(symbol_1.Symbol.nonterminalSExpression, [symbol_1.Symbol.terminalIntegerLiteral], 48));
        // S-Expression -> Symbol
        // Productions.Add(new Production(Symbol.N_SExpression, new List<object>() { Symbol.N_Symbol }, 49));
        this.productions.push(new production_1.Production(symbol_1.Symbol.nonterminalSExpression, [symbol_1.Symbol.nonterminalSymbol], 49));
        // S-Expression -> ( S-Expression-List )
        // Productions.Add(new Production(Symbol.N_SExpression, new List<object>() { Symbol.T_LeftBracket, Symbol.N_SExpressionList, Symbol.T_RightBracket }, 50));
        ...
        this.productions.push(new production_1.Production(symbol_1.Symbol.nonterminalSExpressionList, [
            symbol_1.Symbol.nonterminalSExpression,
            symbol_1.Symbol.terminalDot,
            symbol_1.Symbol.nonterminalSExpression,
            '#sExpressionList'
        ], 52));
        // S-Expression-List -> Lambda
        // Productions.Add(new Production(Symbol.N_SExpressionList, new List<object>() { Symbol.Lambda, "#emptySExpressionList" }, 53));
        this.productions.push(new production_1.Production(symbol_1.Symbol.nonterminalSExpressionList, [symbol_1.Symbol.Lambda, '#emptySExpressionList'], 53));
        // Symbol -> Name
        // Productions.Add(new Production(Symbol.N_Symbol, new List<object>() { Symbol.T_ID, "#symbol" }, 54));
        this.productions.push(new production_1.Production(symbol_1.Symbol.nonterminalSymbol, [symbol_1.Symbol.terminalID, '#symbol'], 54));
        // BracketedExpression -> cond ( Expression Expression ) ExprPairList
        // Productions.Add(new Production(Symbol.N_BracketedExpression, new List<object>() {
        //     Symbol.T_Cond,
        //     Symbol.T_LeftBracket,
    ...
    get selectorsOfCompatibleParsers() {
        return [
            parser_selectors_1.ParserSelector.LR1,
            parser_selectors_1.ParserSelector.SLR1,
            parser_selectors_1.ParserSelector.LALR1
        ];
    }
...
exports.LISPGrammarForLRParser = LISPGrammarForLRParser;
